...
LG.ACAOM_DT_INCLUSAO AS INCLUSÃO,
...
AND LG.ACAOM_DT_EXCLUSAO IS NULL  -- NAO TENHA DATA DE EXCLUSÃO

AND LG.ACAOM_DT_ALTERACAO >= '22-JUN-2020' -- ALTERAÇÃO ENTRE ONTEM E HOJE
and LG.ACAOM_DT_ALTERACAO < '23-JUN-2020' -- ALTERAÇÃO ENTRE ONTEM E HOJE

AND LG.ACAOM_DT_ALTERACAO <> LG.ACAOM_DT_INCLUSAO --apenas alterações de pedidos ja colocados.
